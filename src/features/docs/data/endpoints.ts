...
export const endpoints: Endpoint[] = [
  ...
  // ─── Agent ───
  {
    ...
    summary: 'Agent Reply',
    description:
      'Sends a message to the AI agent and receives a reply. The agent evaluates the applicant based on the conversation context.',
    tag: 'Agent',
    pathParams: [],
    queryParams: [],
    requestBody: JSON.stringify(
    ...
    responseExample: JSON.stringify(
      {
        message: 'Based on your response, I can see strong leadership qualities...',
        status: 'success',
        question: {
          question: 'Can you describe a time you led a team?',
          answer: 'I organized a volunteer group of 20 students...',
        },
      },
      null,
      2,
