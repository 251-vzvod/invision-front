...
export const endpoints: Endpoint[] = [
  ...
  // ─── ML Assessments ───
  {
    ...
    description:
      'Returns a paginated list of the latest ML assessments for all applicants. Includes scores, recommendation, and eligibility status for each candidate.',
    tag: 'ML Assessments',
    pathParams: [],
    queryParams: [
      { name: 'page', type: 'integer', description: 'Page number (starts at 1)', required: false, default: 1 },
      { name: 'size', type: 'integer', description: 'Items per page (1–100)', required: false, default: 25 },
    ],
    requestBody: null,
    responseExample: JSON.stringify(
      {
